...
class WidgetFramework_ControllerPublic_WidgetPage extends XenForo_ControllerPublic_Abstract
{
    ...
    public function actionIndex()
    {
        ...
        $this->canonicalizeRequestUrl(XenForo_Link::buildPublicLink('widget-pages', $widgetPage,
            array('page' => $page)));
    ...
    public static function getSessionActivityDetailsForList(array $activities)
    {
        ...
        if ($nodeIds) {
            ...
            $widgetPages = $widgetPageModel->getWidgetPages(array('node_id' => $nodeIds),
    ...
    protected function _getWidgetPageOrError($nodeIdOrName)
    {
        ...
        if (!$widgetPage || $widgetPage['node_type_id'] != 'WF_WidgetPage') {
            throw $this->responseException($this->responseError(new XenForo_Phrase('wf_requested_widget_page_not_found'),
                404));
        }
