...
// updated by DevHelper_Helper_ShippableHelper at 2017-12-05T23:18:09+00:00
...
class WidgetFramework_ShippableHelper_Updater
{
    ...
    public static function onInitDependencies(
        ...
        $GLOBALS[self::KEY]['version'][$apiUrl][self::$_version]
            = 'WidgetFramework_ShippableHelper_UpdaterCore';
    ...
    public static function onUninstall($apiUrl = null, $addOnId = null)
    {
        ...
        if (empty($activeAddOnIds)) {
            ...
            WidgetFramework_ShippableHelper_UpdaterCore::_uninstallSelf($apiUrl);
        }
    }
