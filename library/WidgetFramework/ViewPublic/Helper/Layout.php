...
class WidgetFramework_ViewPublic_Helper_Layout
{
    ...
    public static function prepareSidebarWidgets(
        XenForo_ViewPublic_Base $view,
        array &$widgets,
        array $options = array()
    ) {
        ...
        switch (count($this->_subLayouts)) {
            ...
            default:
                ...
                foreach (array_keys($this->_subLayouts) as $layoutId) {
                    ...
                    $cssClassXOfY = sprintf('_%dOf%d', preg_replace('/[^0-9]/', '', $columnWidthPercent),
                        $totalColumnsCount);
        ...
        switch (count($this->_subLayouts)) {
            ...
            default:
                ...
                foreach (array_keys($this->_subLayouts) as $layoutId) {
                    ...
                    $html .= sprintf('<li class="WidgetFramework_WidgetPage_LayoutRow %s %s">', $cssClassRows,
                        $cssClassIsLast);
                    $html .= $subLayout;
                    $html .= '</li>';
                }
    ...
    protected function _doLayout(array $widgetIds)
    {
        ...
        foreach ($groupIdsOrdered as $groupId) {
            ...
            if (empty($subLayoutWidgetIds)) {
                ...
                $this->_subLayouts[$groupId] = $this->_newSubLayout($this->_widgets, $subLayoutWidgetIds,
                    $this->_depth + 1);
                $this->_subLayoutIndeces[$groupId] = $indeces;
            }
        }
...
class _Layout_Single
{
    ...
    public function prepare()
    {
        ...
        WidgetFramework_Core::getInstance()->prepareWidgetsForHook($this->_hookName, $this->_options['params'],
            $this->_options['templateObj']);
    ...
    public function render()
    {
        ...
        WidgetFramework_Core::getInstance()->renderWidgetsForHook($this->_hookName, $this->_options['params'],
            $this->_options['templateObj'], $this->_rendered);
