...
class WidgetFramework_ControllerAdmin_WidgetPage extends XenForo_ControllerAdmin_NodeAbstract
{
    ...
    public function actionEdit()
    {
        ...
        $viewParams = array(
            ...
            'widgets' => $widgets,
            'nodeParentOptions' => $this->_getNodeModel()->getNodeOptionsArray($this->_getNodeModel()->getPossibleParentNodes($widgetPage),
                $widgetPage['parent_node_id'], true),
    ...
    public function actionDeleteConfirm()
    {
        ...
        $viewParams = array(
            ...
            'nodeParentOptions' => $nodeModel->getNodeOptionsArray($nodeModel->getPossibleParentNodes($widgetPage),
                $widgetPage['parent_node_id'], true)
        );
